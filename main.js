...
const internships = document.querySelector("#help");
const intern = document.querySelector(".ourservices");
...
//navbar color change when user  scroll
...
//container color change when user scroll
window.addEventListener("scroll" , function(){
    if(window.scrollY > 50){
